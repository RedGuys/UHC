...
import ru.redguy.reduhc.utils.discord.Hook;
...
public class Config {
    ...
    public static void Load() {
        FileConfiguration configuration = RedUHC.Instance.getConfig();
        hooks = new ArrayList<>();
    ...
    public static void Save() {
        ...
        try {
            configuration.save(new File(RedUHC.Instance.getDataFolder(),"config.yml"));
        } catch (IOException e) {

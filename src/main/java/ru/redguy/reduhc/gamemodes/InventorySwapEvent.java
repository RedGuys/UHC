...
public class InventorySwapEvent implements Event {
    ...
    public void registerTimers() {
        ...
        tasks.add(scheduler.scheduleSyncRepeatingTask(RedUHC.getInstance(), new RunnablePresets.Timer("смены инвентарей",270,this),600,6000));
        tasks.add(scheduler.scheduleSyncRepeatingTask(RedUHC.getInstance(), new InventorySwap(),6000,6000));
    }
